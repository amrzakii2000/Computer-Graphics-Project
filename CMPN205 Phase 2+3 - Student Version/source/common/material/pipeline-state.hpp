...
namespace our {
    ...
    struct PipelineState {
        ...
        //If true, the value of the channel can be changed
        glm::bvec4 colorMask = {true, true, true, true}; // To know how to use it, check glColorMask
        
        //depth mask: saves the previous state of he object and does not re-draw except if it is closer than previously saved in the buffer
